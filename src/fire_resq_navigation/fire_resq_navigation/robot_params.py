...
def find_parameters_xacro() -> Path:
    """Installed description if the workspace is sourced, otherwise the source tree."""
    try:
        ...
        pass
    return Path(__file__).resolve().parents[2] / 'fire_resq_description' / 'urdf' / 'parameters.xacro'
